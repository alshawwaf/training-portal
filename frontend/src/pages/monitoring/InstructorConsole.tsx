    ...
    if (classes.length === 0) {
        return (
            <div className="min-h-[70vh] flex items-center justify-center">
                <div className="glass rounded-[3rem] border border-theme p-16 text-center max-w-lg shadow-2xl">
                    <div className="w-24 h-24 mx-auto mb-8 rounded-[2rem] bg-gradient-to-br from-indigo-500/20 to-purple-500/20 flex items-center justify-center border border-indigo-500/30">
                        <Monitor className="w-12 h-12 text-indigo-400" />
                    </div>
                    <h2 className="text-3xl font-black text-primary mb-4 tracking-tight">No Active Classes</h2>
                    <p className="text-secondary font-medium mb-8 leading-relaxed">
                        There are no active or upcoming classes to monitor. Create a class to start managing student environments.
                    </p>
                    <a 
                        href="/classes"
                        className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-bold rounded-2xl transition-all shadow-lg hover:shadow-xl hover:scale-105"
                    >
            ...
            <div className="p-4">
                ...
                <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                        <div className={clsx(
                            "w-10 h-10 rounded-xl flex-shrink-0 flex items-center justify-center text-white font-bold",
