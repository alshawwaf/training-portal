...
export const statusConfig: Record<string, { label: string; color: string; bgColor: string }> = {
    ...
    completed: { label: 'Completed', color: 'text-blue-400', bgColor: 'bg-blue-500/10 border-blue-500/20' },
    upcoming: { label: 'Upcoming', color: 'text-amber-400', bgColor: 'bg-amber-500/10 border-amber-500/20' },
